...
| PASS | release-metadata-sync | Course 1 version 2.5.0, practice revision 4, app metadata, manifest, and release documents agree |
...
| PASS | current-json-syntax | 15 in-scope JSON files parsed |
...
| PASS | internal-links | 74 current local targets exist; 8 archived/generated targets ignored |
